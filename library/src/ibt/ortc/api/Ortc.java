 ...
 *   OrtcFactory factory;
 * 
 *   factory = ortc.loadOrtcFactory(&quot;IbtNubiumSJ&quot;);
 * 
...
public class Ortc {
   ...
   * @param proxy Object with definition of proxy connection (Proxy) or null if no proxy should be used
   ...
   * @param proxy  Object with definition of proxy connection (Proxy)
   * @param callback
