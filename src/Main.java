...
public class Main {
    ...
    private static final String defaultServerUrl = "http://ortc-prd.nubium.io/server/2.1";
    private static final boolean defaultIsBalancer = true;
    private static final String defaultApplicationKey = "YOUR_APP_KEY";
    private static final String defaultPrivateKey = "YOUR_PRIVATE_KEY";
    private static final String defaultAuthenticationToken = "NubiumDemo";
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to Nubium Messaging Java Demo");
    ...
    private static void connectOrtcClient() throws Exception {
        ...
        OrtcFactory factory = api.loadOrtcFactory("IbtNubiumSJ");
